...
class Company_m extends MY_Model {
	...
	public $signup_rules = array(
		...
		'password' => array(
			'field' => 'password',
			'label' => 'Password',
			'rules' => 'trim|required|matches[konfirmasi_password]|min_length[8]|max_length[20]|xss_clean',
			),
	...
	public function login($data){		
		...
		$sql = "SELECT * FROM t_user JOIN t_perusahaan USING(id_user) WHERE email = ? AND password = ? AND status_user ='COMPANY' AND block = 0 ";
