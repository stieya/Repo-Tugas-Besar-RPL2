						...
						<div class="box">
							...
							<div class="box-content">
								...
								<div class="search-info">	
									...
									<div class="box-content">
										<a target="_blank" href="<?php echo base_url().'files/company/'.$jobsheets->jobsheetdetail->id_job_sheet.'/'.$job_list->file_perusahaan;?>"class="btn-block btn-primary btn btn-large "> Download File </a>
									</div>
									<?php else : ?>
									...
									<div class="top">
										<div class="left">
											<div class="fileupload-new thumbnail" style="width: 80px; height: 80px;">
												<?php if($pekerja->studentjobsheet->foto_user != NULL) : ?>
												<img src="<?php echo base_url().$pekerja->studentjobsheet->foto_user; ?>" class="img-responsive" style="width: 80px; height: 80px;"/>
												<?php else : ?>
						...
						<div class="box">
							...
							<div class="box-content">
								<div class="statistic-big">
									...
									<?php if(count($pekerja->studentjoblist)>0 && $pekerja->studentjoblist[0]->file_user != ""  ):?>
									<?php foreach($pekerja->studentjoblist as $kerja) : ?>									
										<h4 class="text-center">
											 <a target="_blank" href="<?php echo base_url().$kerja->file_user;?>"class="btn-block btn-primary btn btn-large "> Download File  </a>
										</h4>
										<?php endforeach; ?>
										<?php else : ?>
							...
							<div class="box-content nopadding scrollable" data-height="600" data-start="bottom">
								<ul class="messages">
									...
									<li class="right">
										<div class="image">
											<?php if($comment->foto_user != NULL) : ?>
											<img src="<?php echo base_url().$comment->foto_user;?>" alt="">
											<?php else : ?>
											<img src="<?php echo base_url(); ?>img/no_image.png" alt="">
											<?php endif; ?>
										</div>
