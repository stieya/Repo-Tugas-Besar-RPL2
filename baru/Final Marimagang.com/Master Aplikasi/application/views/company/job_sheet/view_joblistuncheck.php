...
<body>
	...
	<div class="modal-dialog text-center" style="width:40%;margin-left:30%;margin-top:120px;background:#95a5a6;" >
		<div class="modal-content">
			<div class="modal-head">
				<h3>Job List <?php echo $data->head; ?> Dikerjakan kembali</h3>
				</p>
			</div>
			<div class="modal-body text-center">
				<p>
					Job List <?php echo $data->head; ?> Dari Job Sheet <?php echo $data->nama_job_sheet; ?> Telah Diubah Statusnya Menjadi Belum Selesai.
	...
	$(document).ready(function(){
		setTimeout(function(){
			window.location.href = '<?php echo base_url(); ?>company/jobsheet/<?php echo $id_job_sheet;?>';
		},4000);
	});
