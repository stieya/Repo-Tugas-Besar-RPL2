...
<body>
	...
	<div class="modal-dialog text-center" style="width:40%;margin-left:30%;margin-top:120px;background:#95a5a6;" >
		<div class="modal-content">
			<div class="modal-head">
				<h3>Job Sheet <?php echo $data->nama_job_sheet; ?> Selesai</h3>
				</p>
			</div>
			<div class="modal-body text-center">
				<p>
					Job Sheet  <?php echo $data->nama_job_sheet; ?> Telah Selesai . Terima kasih telah menggunakan Yukmagang.com untuk menylesaikan pekerjaan ini.

					Dalam 5 Detik Anda Akan Dikirim Kembali Ke halaman Utama. Jika Dalam 5 Detik Tidak Terjadi Apa-Apa Silahkan Klik Link Dibawah Ini.
				</p>
				<p>
	...
	$(document).ready(function(){
		setTimeout(function(){
			window.location.href = 'http://localhost/E-Magang/company/jobsheet';
		},4000);
	});
