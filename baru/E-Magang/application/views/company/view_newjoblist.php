				...
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="box box-bordered">
							<div class="box-title">
								<h3><i class="icon-th-list"></i> Form Pembuatan Job List Untuk <?php echo $jobsheets->jobsheetdetail->nama_job_sheet ?></h3>
							</div>
								...
								<div class="text-center">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<span class="help-block">Only .rar/.zip (Max Size: 50MB)</span>
										</div>
									</div>
									<div class="control-group">
										<label for="textarea" class="control-label">Deskripsi Job Sheet</label>
										<div class="controls">
											<textarea name="deskripsi" id="textarea" rows="5" class="input-block-level">Deskripsi Job Sheet </textarea>
										</div>
									</div>
