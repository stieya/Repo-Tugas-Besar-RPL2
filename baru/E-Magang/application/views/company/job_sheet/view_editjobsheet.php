						...
						<div class="box box-bordered">
							...
							<div class="box-content nopadding">
								<div class="text-center">
									...
									<div class="control-group">
										<label for="select" class="control-label">Status Pekerjaan</label>
										<div class="controls">
											<select name="status" id="select" class='input-large'>
												<?php if($jobsheet->status == 'Finished') : ?>
												<option value="Finished" selected="selected">Sudah Selesai</option>
												<?php else : ?>
												<option value="Finished" >Sudah Selesai</option>
												<?php endif; ?>

												<?php if($jobsheet->status == 'Ongoing') : ?>
												<option value="Ongoing" selected="selected">Sedang Dikerjakan</option>
												<?php else : ?>
												<option value="Ongoing" >Sedang Dikerjakan</option>
												<?php endif; ?>

												<?php if($jobsheet->status == 'Unclaimed') : ?>
												<option value="Unclaimed" selected="selected">Belum Dikerjakan</option>
												<?php else : ?>
												<option value="Unclaimed">Belum Dikerjakan</option>
												<?php endif; ?>
