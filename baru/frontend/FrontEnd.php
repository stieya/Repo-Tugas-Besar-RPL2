    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="container">
            <div class="navbar-header">
				...
				<span style="background-color:#f1c40f;  padding:8px 8px; color:#fff;">Yuk</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-message">
                        <h1>Yuk! Kita Magang</h1>
                        <h3>Dapatkan pengalaman mengesankan bersama kami</h3>
                       
                        <ul class="list-inline intro-social-buttons">
                          
						  <li>
								<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal-mh">
								<i class="fa fa-users fa-fw"></i> <span class="network-name">Login Mahasiswa </button>
                           
						   </li>
						   
						   <li>
								<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal-ph">
								<i class="fa fa-user fa-fw"></i> <span class="network-name">Login Perusahaan </button>
						   </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    ...
                    <button class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal-signup-ph">
					<i class="fa fa-user fa-fw"></i> <span class="network-name">Sign up Perusahaan</button>


                </div>
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    <img class="img-responsive" src="img/company.gif"
                    alt="">
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
                    ...
                    <button class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal-signup-mh">
					<i class="fa fa-user fa-fw"></i> <span class="network-name">Sign up Mahasiswa</button>

                </div>
                <div class="col-lg-5 col-sm-pull-6  col-sm-6">
                    <img class="img-responsive" src="img/mahasiswa.jpg" alt="">
                </div>
            </div>
            ...
            <div class="row">
         	...
         	<div class="clearfix"></div>
         	  <div class="col-xs-12 col-sm-12 col-md-4">
	                	...
	                	<img class="quote-author-pic" src="img/testimoni/foto.jpg">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
	                	<blockquote class="quote-text">
	                		...
	                		Benar-benar sangat membantu sekali untuk melihat kinerja kerja aku selama magang, pembimbing aku meskipun sering pulang pergi luar kota, dia bisa tetap monitor aku dari jauh, Terima kasih yukmagang.com
	                	</blockquote>

	                	<img class="quote-author-pic" src="img/testimoni/foto (1).jpg">
              	  ...
              	  <div class="col-xs-12 col-sm-6 col-md-4">
	                	...
	                	<img class="quote-author-pic" src="img/testimoni/foto (2).jpg">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
					...
					<span style="background-color:#f1c40f;  padding:10px 10px; color:#fff; font-size:30px;">Yuk</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="copyright text-muted small">Copyright &copy; Ozan Soft Teknologi Utama 2014. All Rights Reserved</p>
                    	...
                    	<img src="img/media.gif" class="col-lg-5 col-sm-6" id="media">
